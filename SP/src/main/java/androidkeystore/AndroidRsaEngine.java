...
public class AndroidRsaEngine implements AsymmetricBlockCipher {
    ...
    public AndroidRsaEngine(String keyAlias, boolean isSigner) {
        ...
        try {
            ...
            keyStore.load(null);
            KeyStore.Entry keyEntry = keyStore.getEntry(
                    this.keyAlias, null);
            publicKey = (RSAPublicKey) ((KeyStore.PrivateKeyEntry) keyEntry)
                    .getCertificate().getPublicKey();
            privateKey = (RSAPrivateKey) ((KeyStore.PrivateKeyEntry) keyEntry)
                    .getPrivateKey();
